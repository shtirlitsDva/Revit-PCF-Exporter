...
using pd = PcfExporter.Model.ParameterData;
...
namespace PcfExporter.Model
{
    ...
    public static class Parameters
    {
        ...
        public static readonly pdef PCF_ELEM_TAPS = new pdef("PCF_ELEM_TAPS", ParameterDomain.ELEM, ParameterUsage.PROGRAMMATIC, pd.Text, new Guid("38CE9E37-C6D0-4233-9B6B-CB2E26BF849F"));
        ...
        /// <summary>Parameter group for pipeline (PipingSystemType) bindings.</summary>
        public static ForgeTypeId PipelineParameterGroup { get; } = GroupTypeId.AnalyticalModel;
