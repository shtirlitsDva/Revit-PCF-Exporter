...
namespace PcfExporter.Model
{
    internal class PCF_VIRTUAL_NN_GASKET : PcfVirtualElement
    {
        ...
        public PCF_VIRTUAL_NN_GASKET(Element element, ExportSession s) : base("GASKET", s) 
        { 
        ...
        {
            endData.Add(($"    END-POINT {PcfExporter.Writer.PcfFormat.PointMm(location)} {Conversion.PipeSizeToMm(size)} FL"));
        }
    }
}
