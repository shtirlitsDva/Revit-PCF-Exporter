...
namespace PcfExporter.Model
{
    internal class PCF_VIRTUAL_FIELDWELD : PcfVirtualElement
    {
        ...
        public PCF_VIRTUAL_FIELDWELD((Connector c1, Connector c2) cons, ExportSession s) : base("WELD", s)
        {
            this.Cons = cons;
            ...
            endData.Add($"    END-POINT {PcfExporter.Writer.PcfFormat.PointMm(cons.c1.Origin)} {Conversion.PipeSizeToMm(cons.c1.Radius)} BW");
            endData.Add($"    END-POINT {PcfExporter.Writer.PcfFormat.PointMm(cons.c2.Origin)} {Conversion.PipeSizeToMm(cons.c2.Radius)} BW");
        }
    }
}
