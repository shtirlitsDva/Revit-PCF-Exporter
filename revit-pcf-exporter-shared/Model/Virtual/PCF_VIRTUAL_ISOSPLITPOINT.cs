...
namespace PcfExporter.Model
{
    internal class PCF_VIRTUAL_ISOSPLITPOINT : PcfVirtualElement
    {
        ...
        public PCF_VIRTUAL_ISOSPLITPOINT((Connector c1, Connector c2) cons, ExportSession s) : base("ISO-SPLIT-POINT", s)
        {
            this.Cons = cons;
            ...
            endData.Add($"    CO-ORDS {PcfExporter.Writer.PcfFormat.PointMm(centre)}");
        }
    }
}
