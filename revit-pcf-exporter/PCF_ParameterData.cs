...
namespace PCF_Functions
{
    ...
    public class ParameterList
    {
        ...
        public readonly pdef PCF_ELEM_COMPID = new pdef("PCF_ELEM_COMPID", "ELEM", "P", pd.Text, new Guid("4EAB3C7A-C0BF-4E9A-B7B9-978407C12800"));
        public readonly pdef PCF_MAT_ID = new pdef("PCF_MAT_ID", "ELEM", "P", pd.Text, new Guid("DE851B73-AFEA-4B38-9BCB-EFC8CBA78B16"), "MATERIAL-IDENTIFIER");
        ...
        public readonly pdef PCF_PIPL_AT11 = new pdef("PCF_REVA", "PIPL", "U", pd.Text, new Guid("C7780B12-8CBD-41D6-2534-7F99C6510910"), "ATTRIBUTE11", "LDT");
        public readonly pdef PCF_PIPL_AT12 = new pdef("PCF_ADESCR", "PIPL", "U", pd.Text, new Guid("173B1840-A680-5488-6694-9AF103346395"), "ATTRIBUTE12", "LDT");
        public readonly pdef PCF_PIPL_AT13 = new pdef("PCF_ADATO", "PIPL", "U", pd.Text, new Guid("BDF51F06-5157-9088-9A15-995664CF319C"), "ATTRIBUTE13", "LDT");
        public readonly pdef PCF_PIPL_AT14 = new pdef("PCF_ADRWN", "PIPL", "U", pd.Text, new Guid("1B2D7F77-6255-068C-169A-BEA8424923C4"), "ATTRIBUTE14", "LDT");
        public readonly pdef PCF_PIPL_AT15 = new pdef("PCF_AKONTR", "PIPL", "U", pd.Text, new Guid("079274BA-01F5-3C15-7E71-82DCCA15402F"), "ATTRIBUTE15", "LDT");
        public readonly pdef PCF_PIPL_AT16 = new pdef("PCF_AGODK", "PIPL", "U", pd.Text, new Guid("8BD6ADC2-9AE2-4011-2187-4DBC355C7623"), "ATTRIBUTE16", "LDT");
        public readonly pdef PCF_PIPL_AT17 = new pdef("PCF_REVB", "PIPL", "U", pd.Text, new Guid("F2BEA8F2-9B7A-77CC-00C1-5FE098098A53"), "ATTRIBUTE17", "LDT");
        public readonly pdef PCF_PIPL_AT18 = new pdef("PCF_BDESCR", "PIPL", "U", pd.Text, new Guid("8C864664-2F15-31ED-A54A-FAD70E77829C"), "ATTRIBUTE18", "LDT");
        public readonly pdef PCF_PIPL_AT19 = new pdef("PCF_BDATO", "PIPL", "U", pd.Text, new Guid("6358B8E3-1BD3-4EC0-67AB-232EBB127635"), "ATTRIBUTE19", "LDT");
        public readonly pdef PCF_PIPL_AT20 = new pdef("PCF_BDRWN", "PIPL", "U", pd.Text, new Guid("55B5AF79-124C-A5E0-2A1C-D917F11A1574"), "ATTRIBUTE20", "LDT");
        public readonly pdef PCF_PIPL_AT21 = new pdef("PCF_BKONTR", "PIPL", "U", pd.Text, new Guid("AE5A4402-33F0-518B-7810-90688BD20389"), "ATTRIBUTE21", "LDT");
        public readonly pdef PCF_PIPL_AT22 = new pdef("PCF_BGODK", "PIPL", "U", pd.Text, new Guid("E3AA91E9-88F1-6273-1A24-7072C4BD12CE"), "ATTRIBUTE22", "LDT");
        public readonly pdef PCF_PIPL_AT23 = new pdef("PCF_REVC", "PIPL", "U", pd.Text, new Guid("85338580-4E9F-4490-47E1-4A123F325871"), "ATTRIBUTE23", "LDT");
        public readonly pdef PCF_PIPL_AT24 = new pdef("PCF_CDESCR", "PIPL", "U", pd.Text, new Guid("CAC034B5-8CC2-36B3-7196-BBEAB5B03D62"), "ATTRIBUTE24", "LDT");
        public readonly pdef PCF_PIPL_AT25 = new pdef("PCF_CDATO", "PIPL", "U", pd.Text, new Guid("21D7BA7D-4511-7994-82A8-8BB1827F0DA9"), "ATTRIBUTE25", "LDT");
        public readonly pdef PCF_PIPL_AT26 = new pdef("PCF_CDRWN", "PIPL", "U", pd.Text, new Guid("69CE6D6A-67E7-9452-73B1-7AA619818FD3"), "ATTRIBUTE26", "LDT");
        public readonly pdef PCF_PIPL_AT27 = new pdef("PCF_CKONTR", "PIPL", "U", pd.Text, new Guid("528988A7-1CB1-0255-46AD-A15DB6ED84E9"), "ATTRIBUTE27", "LDT");
        public readonly pdef PCF_PIPL_AT28 = new pdef("PCF_CGODK", "PIPL", "U", pd.Text, new Guid("E7EFD4A9-57C5-70BC-1B8D-42455B922C7D"), "ATTRIBUTE28", "LDT");
        public readonly pdef PCF_PIPL_AT29 = new pdef("PCF_REVD", "PIPL", "U", pd.Text, new Guid("38621431-31DF-9335-591B-90B59CDC4D66"), "ATTRIBUTE29", "LDT");
        public readonly pdef PCF_PIPL_AT30 = new pdef("PCF_DDESCR", "PIPL", "U", pd.Text, new Guid("105EF16F-2A56-1B9D-6A76-FE97D86D6BE9"), "ATTRIBUTE30", "LDT");
        public readonly pdef PCF_PIPL_AT31 = new pdef("PCF_DDATO", "PIPL", "U", pd.Text, new Guid("1F4178A3-85BC-601D-38AF-082F4B5181A6"), "ATTRIBUTE31", "LDT");
        public readonly pdef PCF_PIPL_AT32 = new pdef("PCF_DDRWN", "PIPL", "U", pd.Text, new Guid("10EAD0DF-4C7A-29EB-8DCF-C38791223E32"), "ATTRIBUTE32", "LDT");
        public readonly pdef PCF_PIPL_AT33 = new pdef("PCF_DKONTR", "PIPL", "U", pd.Text, new Guid("30BDED8B-9B34-6097-7468-9D8F9E551361"), "ATTRIBUTE33", "LDT");
        public readonly pdef PCF_PIPL_AT34 = new pdef("PCF_DGODK", "PIPL", "U", pd.Text, new Guid("3B8A98CF-7037-5059-71CA-5FBC262724E5"), "ATTRIBUTE34", "LDT");
        public readonly pdef PCF_PIPL_AT35 = new pdef("PCF_REVE", "PIPL", "U", pd.Text, new Guid("CD58BFC3-7B30-1342-81E8-437D86235930"), "ATTRIBUTE35", "LDT");
        public readonly pdef PCF_PIPL_AT36 = new pdef("PCF_EDESCR", "PIPL", "U", pd.Text, new Guid("CC8588D7-0FF6-3360-7B65-282A0969A09D"), "ATTRIBUTE36", "LDT");
        public readonly pdef PCF_PIPL_AT37 = new pdef("PCF_EDATO", "PIPL", "U", pd.Text, new Guid("DD0646F7-06A2-2FD6-2136-D76508526432"), "ATTRIBUTE37", "LDT");
        public readonly pdef PCF_PIPL_AT38 = new pdef("PCF_EDRWN", "PIPL", "U", pd.Text, new Guid("93F0BB1D-6CB0-A608-338F-1BA8D5E152DC"), "ATTRIBUTE38", "LDT");
        public readonly pdef PCF_PIPL_AT39 = new pdef("PCF_EKONTR", "PIPL", "U", pd.Text, new Guid("EC380881-6257-013B-9334-ABF6474E8C3F"), "ATTRIBUTE39", "LDT");
        public readonly pdef PCF_PIPL_AT40 = new pdef("PCF_EGODK", "PIPL", "U", pd.Text, new Guid("6F4380C4-300C-9580-1D4B-492BB69B13A1"), "ATTRIBUTE40", "LDT");
        public readonly pdef PCF_PIPL_AT41 = new pdef("PCF_REVF", "PIPL", "U", pd.Text, new Guid("07AF10BC-6F19-24C7-7039-5A85B3916C74"), "ATTRIBUTE41", "LDT");
        public readonly pdef PCF_PIPL_AT42 = new pdef("PCF_FDESCR", "PIPL", "U", pd.Text, new Guid("FB007487-69D7-5682-61F8-D8D1203266BD"), "ATTRIBUTE42", "LDT");
        public readonly pdef PCF_PIPL_AT43 = new pdef("PCF_FDATO", "PIPL", "U", pd.Text, new Guid("6B1AF5AB-57EA-9184-2E00-EF21DF9E3314"), "ATTRIBUTE43", "LDT");
        public readonly pdef PCF_PIPL_AT44 = new pdef("PCF_FDRWN", "PIPL", "U", pd.Text, new Guid("5A1898C8-5085-8734-9435-29F52A275BD8"), "ATTRIBUTE44", "LDT");
        public readonly pdef PCF_PIPL_AT45 = new pdef("PCF_FKONTR", "PIPL", "U", pd.Text, new Guid("65D7A90A-79F9-8859-6CE6-D86C373B556C"), "ATTRIBUTE45", "LDT");
        public readonly pdef PCF_PIPL_AT46 = new pdef("PCF_FGODK", "PIPL", "U", pd.Text, new Guid("8AECB123-457F-786E-A09E-26276613295F"), "ATTRIBUTE46", "LDT");
        public readonly pdef PCF_PIPL_AT47 = new pdef("PCF_REVG", "PIPL", "U", pd.Text, new Guid("2FE3B9B5-1EA1-1DDA-8A2E-E343A6632D1D"), "ATTRIBUTE47", "LDT");
        public readonly pdef PCF_PIPL_AT48 = new pdef("PCF_GDESCR", "PIPL", "U", pd.Text, new Guid("33F75B5E-44B8-1DD4-3AAA-A16B91DC8C7E"), "ATTRIBUTE48", "LDT");
        public readonly pdef PCF_PIPL_AT49 = new pdef("PCF_GDATO", "PIPL", "U", pd.Text, new Guid("D92492C8-8821-5221-A24F-05929CFF3218"), "ATTRIBUTE49", "LDT");
        public readonly pdef PCF_PIPL_AT50 = new pdef("PCF_GDRWN", "PIPL", "U", pd.Text, new Guid("BB83F44B-0E28-72AB-160B-30CF5C746496"), "ATTRIBUTE50", "LDT");
        public readonly pdef PCF_PIPL_AT51 = new pdef("PCF_GKONTR", "PIPL", "U", pd.Text, new Guid("678B80FC-88F1-5655-9E29-F3BA201277C3"), "ATTRIBUTE51", "LDT");
        public readonly pdef PCF_PIPL_AT52 = new pdef("PCF_GGODK", "PIPL", "U", pd.Text, new Guid("3B140316-95CB-1069-40DA-6BC0E6060D2A"), "ATTRIBUTE52", "LDT");
        public readonly pdef PCF_PIPL_AT53 = new pdef("PCF_REVH", "PIPL", "U", pd.Text, new Guid("BA4E2D62-3430-4F5E-3A9C-F2714FB3444C"), "ATTRIBUTE53", "LDT");
        public readonly pdef PCF_PIPL_AT54 = new pdef("PCF_HDESCR", "PIPL", "U", pd.Text, new Guid("A654983A-76CC-42E3-47A5-4FF0F7724C4D"), "ATTRIBUTE54", "LDT");
        public readonly pdef PCF_PIPL_AT55 = new pdef("PCF_HDATO", "PIPL", "U", pd.Text, new Guid("520AFC62-2684-3FFF-99DA-2C94832A08D5"), "ATTRIBUTE55", "LDT");
